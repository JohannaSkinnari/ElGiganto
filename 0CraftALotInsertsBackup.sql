...
-- GO
-- 2
-- EXEC dbo.spCustomer_CreateCustomer 'Erik', 'Skinnari', 'Östergårdsplan', '6', '50760', 'Borås'
-- GO
-- 3
-- EXEC dbo.spCustomer_CreateCustomer 'Zoë', 'Skinnari', 'Östergårdsplan', '6', '50760', 'Borås'
-- GO
-- 4
-- EXEC dbo.spCustomer_CreateCustomer 'Elliott', 'Skinnari', 'Östergårdsplan', '6', '50760', 'Borås'
-- GO
-- 5
-- EXEC dbo.spCustomer_CreateCustomer 'Annika', 'Fellert Ohlén', 'Östergårdsplan', '6', '50760', 'Borås'
-- GO
...
SET @randomProduct = FLOOR(RAND()*(12-1+1))+1;
