...
EXEC dbo.spProduct_ProductListByCategory 3
GO 
...
EXEC dbo.spCart_AddToCart @CartId = 1, @ProductId = 7, @Quantity = 4;
GO
...
CREATE OR ALTER PROCEDURE dbo.spCartProduct_RemoveProductItem
AS
BEGIN
END
GO
    ...
    BEGIN TRY
        BEGIN TRANSACTION
            ...
            SELECT 
                ...
                Product.Price
            FROM CartProduct
            JOIN Product ON Product.Id = CartProduct.Id
            WHERE @CartId = CartProduct.CartId 
...
EXEC dbo.spOrder_Checkout 1, 1, '125'
GO
SELECT * FROM [Order];
